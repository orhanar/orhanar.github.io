...
const seo = {
  ...
  description:
    "A passionate individual who always thrives to work on scalable robust efficient systems that create impact.",
  og: {
    title: "Orhan Arifoglu's Portfolio",
    type: "website",
...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/19x0GKtwXBARJ14i3uf-FdPpo3P51Jkks/view?usp=sharing",
  portfolio_repository: "https://github.com/orhanar/orhanar.github.io",
  githubProfile: "https://github.com/orhanar/orhanar.github.io",
};
...
const socialMediaLinks = [
  ...
  },
  {
    ...
    fontAwesomeIcon: "fa-google", // Reference https://fontawesome.com/icons/at?s=solid
  ...
  degrees: [
    {
      ...
      logo_path: "Education-Logo-Graphics-1-2-modified.png",
      alt_name: "Kingston Uni",
      duration: "2018 - 2020",
      descriptions: [
...
const projectsHeader = {
  title: "Projects",
  description: "My projects makes use of vast variety of tools. My best experience is on creating desktop applications using various programming languages.",
...
const publicationsHeader = {
  ...
  title: "Publications",
  description:
    "I am trying to regularly publish on my blog about various domains of the Computer Science",
  avatar_image_path: "projects_image.svg",
  */
};
...
const contactPageData = {
  ...
  blogSection: {
    title: "Blogs",
    subtitle: "For individual fundamental empowerment, I like to write posts about various domains of Computer Science",
